...
# Plot 2 - Scatter plot (with connecting lines) of Time VS Global Active power
...
with(subsetData,plot(subsetData$dateTime,subsetData$Global_active_power,type="l",ylab="Global Active Power (Kilowatts)",xlab=""))
dev.off()
